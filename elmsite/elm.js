...
var $author$project$Banner$Banner$title = {color: $author$project$Banner$Styles$titleColor, font: $author$project$Banner$Styles$titleFont, lineHeight: $author$project$Banner$Styles$titleLineHeight, size: $author$project$Banner$Styles$titleSize, text: 'Concourse Resources'};
var $author$project$Banner$Banner$banner = {body: $author$project$Banner$Banner$body, container: $author$project$Banner$Banner$container, title: $author$project$Banner$Banner$title};
...
var $author$project$Banner$View$view = function () {
	var title = $author$project$Banner$Banner$banner.title;
	var container = $author$project$Banner$Banner$banner.container;
	var body = $author$project$Banner$Banner$banner.body;
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$fromRgb255(container.backgroundColor)),
				$mdgriffith$elm_ui$Element$Background$image(container.backgroundImage)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$padding(title.lineHeight),
						$mdgriffith$elm_ui$Element$Font$family(
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Font$typeface(title.font)
							])),
						$mdgriffith$elm_ui$Element$Font$color(
						$mdgriffith$elm_ui$Element$fromRgb255(title.color)),
						$mdgriffith$elm_ui$Element$Font$size(title.size),
						$mdgriffith$elm_ui$Element$Font$center
					]),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(title.text)
					])),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Font$typeface(body.font)
							])),
						$mdgriffith$elm_ui$Element$Font$color(
						$mdgriffith$elm_ui$Element$fromRgb255(body.color)),
						$mdgriffith$elm_ui$Element$Font$size(body.size),
						$mdgriffith$elm_ui$Element$Font$center,
						$mdgriffith$elm_ui$Element$width(
						$mdgriffith$elm_ui$Element$px(body.width)),
						$author$project$Common$Common$center
					]),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(body.text)
					]))
			]));
}();
...
var $author$project$Main$layout = A2(
	...
	_List_fromArray(
		[$author$project$Main$banner, $author$project$Main$resourceList]));
var $author$project$Main$main = A2($mdgriffith$elm_ui$Element$layout, _List_Nil, $author$project$Main$layout);
