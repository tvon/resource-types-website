...
var $author$project$Banner$Styles$body = _List_fromArray(
	[
...
var $author$project$Banner$Styles$container = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'height', '176px'),
		A2($elm$html$Html$Attributes$style, 'display', 'grid'),
		A2($elm$html$Html$Attributes$style, 'background-color', '#2A3239'),
		A2($elm$html$Html$Attributes$style, 'background-image', 'url(banner-background.png)'),
		A2($elm$html$Html$Attributes$style, 'background-size', '100%')
	]);
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Banner$Styles$title = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'font-size', '24px'),
		A2($elm$html$Html$Attributes$style, 'display', 'grid'),
		A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
		A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
		A2($elm$html$Html$Attributes$style, 'font-family', 'Roboto Slab'),
		A2($elm$html$Html$Attributes$style, 'color', '#FFFFFF'),
...
var $author$project$Banner$View$view = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Concourse Resources')
				])),
			A2(
			$elm$html$Html$div,
			_Utils_ap(
